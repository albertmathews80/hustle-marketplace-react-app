...
function Sidebar({ setShowScreen }) {
  ...
  const listData = [
    ...
    { state: "categories", icon: offers, text: "Categories" },
    { state: "subCategories", icon: shoppingBag, text: "Sub Categories" },
    { state: "services", icon: earnings, text: "Services" },
    { state: "roles", icon: speechBuuble, text: "Roles" },
    { state: "users", icon: help, text: "Users" },
